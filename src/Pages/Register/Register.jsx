        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-100 to-white flex items-center justify-center px-4">
            <div className="grid lg:grid-cols-2 items-center gap-10 max-w-5xl w-full">
                <div className="hidden lg:flex justify-center">
                    <Lottie animationData={registerLottie} loop={true} style={{ width: '100%', maxWidth: '350px' }} />
                </div>
                <div className="bg-white shadow-xl rounded-2xl p-8 w-full max-w-md">
                    ...
                    <form onSubmit={handleRegister} className="space-y-4">
                        ...
                        <small>Already have an account? <Link className='text-blue-600 underline' to="/signin">SignIn</Link></small>
                    </form>
                </div>
            </div>
        </div>
